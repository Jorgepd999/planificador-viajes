...
public class ItinerarioWebMapper {
    ...
    public static CreateItinerarioCommand toCommand(ItinerarioRequest request, String username) {
        return new CreateItinerarioCommand(request.nombre(), request.destinoId(),
                request.duracion(), request.presupuesto(), request.preferencias(), username);
    }
