...
public class ItinerarioRestController {
    ...
    @PostMapping
    public ResponseEntity<ItinerarioResponse> generar(@Valid @RequestBody ItinerarioRequest request, Principal principal) {
        checkApiVersion();
        String username = principal != null ? principal.getName() : null;
        Itinerario itinerario = generarItinerarioService.generar(ItinerarioWebMapper.toCommand(request, username));
